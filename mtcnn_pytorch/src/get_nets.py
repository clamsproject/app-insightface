...
class PNet(nn.Module):
    ...
    def __init__(self):
        ...
        #weights = np.load('mtcnn_pytorch/src/weights/pnet.npy')[()] #jinny
...
class RNet(nn.Module):
    ...
    def __init__(self):
        ...
        #weights = np.load('mtcnn_pytorch/src/weights/rnet.npy')[()] #jinny
...
class ONet(nn.Module):
    ...
    def __init__(self):
        ...
        #weights = np.load('mtcnn_pytorch/src/weights/onet.npy')[()] #jinny
